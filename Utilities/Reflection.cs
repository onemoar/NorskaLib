...
namespace NorskaLib.Utilities
{
    public struct ReflectionUtils
    {
        ...
        /// <param name="assemblyReferenceType"> Type from assembly other than T. </param>
        /// <returns></returns>
        public static IEnumerable<Type> GetAssignables<T>(Type assemblyReferenceType = null)
        {
            return Assembly.GetAssembly(assemblyReferenceType ?? typeof(T)).GetTypes()
...
//        Console.WriteLine("room assignable from kitchen: {0}", typeof(Room).IsAssignableFrom(typeof(Kitchen)));
